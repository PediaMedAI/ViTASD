...
class AutismDatasetModule(LightningDataModule):
    ...
    def train_dataloader(self) -> TRAIN_DATALOADERS:
        train_dataset = ImageDataset(str(self.data_path / "training"), transform=self.train_transforms,
    ...
    def val_dataloader(self) -> EVAL_DATALOADERS:
        val_dataset = ImageDataset(str(self.data_path / "testing"), transform=self.eval_transforms,
                                   class_map=self.class_map)
    ...
    def test_dataloader(self) -> EVAL_DATALOADERS:
        test_dataset = ImageDataset(str(self.data_path / "testing"), transform=self.eval_transforms,
                                   class_map=self.class_map)
